...
export type AdyenAuthWebhookEvent = z.infer<typeof adyenPaymentAuthSchema>;
export type AdyenWebhookRequestItem = z.infer<typeof notificationRequestItem>;

const notificationRequestItem = z.object({
  amount: z.object({
    currency: z.string(),
    value: z.number(),
  }),
  ...
  additionalData: z.object({
    ...
    captureMerchantReference: z.string().optional(),
...
export const adyenPaymentAuthSchema = z.object({
